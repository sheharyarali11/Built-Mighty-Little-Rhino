<?php
if ( ! defined( 'ABSPATH' ) || ! function_exists( 'woothemes_our_office' ) ) exit; // Exit if accessed directly.

/**
 * WooThemes Our Team Widget
 *
 * A WooThemes standardized office member profiles widget.
 *
 * @package WordPress
...
class Woothemes_Widget_Our_Team extends WP_Widget {
	...
	public function __construct() {
		...
		$this->woothemes_widget_cssclass 	= 'widget_woothemes_our_office';
		$this->woothemes_widget_description = __( 'Team members listed on your site.', 'our-office-by-woothemes' );
		$this->woothemes_widget_idbase 		= 'woothemes_our_office';
		$this->woothemes_widget_title 		= __( 'Our Team', 'our-office-by-woothemes' );
	...
	public function widget( $args, $instance ) {
		...
		// Display the office member profiles.
		woothemes_our_office( $args );
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title (optional):', 'our-office-by-woothemes' ); ?></label>
			<input type="text" name="<?php echo $this->get_field_name( 'title' ); ?>"  value="<?php echo $instance['title']; ?>" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" />
		</p>
		<!-- Widget Limit: Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'limit' ); ?>"><?php _e( 'Limit:', 'our-office-by-woothemes' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'size' ); ?>"><?php _e( 'Image Size (in pixels):', 'our-office-by-woothemes' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'orderby' ); ?>"><?php _e( 'Order By:', 'our-office-by-woothemes' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'order' ); ?>"><?php _e( 'Order Direction:', 'our-office-by-woothemes' ); ?></label>
		...
		<!-- Widget Display Author: Checkbox Input -->
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'display_author' ); ?>"><?php _e( 'Display Name', 'our-office-by-woothemes' ); ?></label>
	   	</p>
       	...
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'display_role' ); ?>"><?php _e( 'Display Role', 'our-office-by-woothemes' ); ?></label>
	   	</p>
		<!-- Widget Display Avatar: Checkbox Input -->
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'display_avatar' ); ?>"><?php _e( 'Display Avatar', 'our-office-by-woothemes' ); ?></label>
	   	</p>
       	...
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'display_url' ); ?>"><?php _e( 'Display URL', 'our-office-by-woothemes' ); ?></label>
	   	</p>
       	...
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'display_additional' ); ?>"><?php _e( 'Display Additional Info', 'our-office-by-woothemes' ); ?></label>
	   	</p>
	   	<!-- Widget Category: Select Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'category' ); ?>"><?php _e( 'Category:', 'our-office-by-woothemes' ); ?></label>
			<?php
				$dropdown_args = array( 'taxonomy' => 'office-member-category', 'class' => 'widefat', 'show_option_all' => __( 'All', 'our-office-by-woothemes' ), 'id' => $this->get_field_id( 'category' ), 'name' => $this->get_field_name( 'category' ), 'selected' => $instance['category'] );
				wp_dropdown_categories( $dropdown_args );
			?>
		</p>
		<!-- Widget ID: Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'specific_id' ); ?>"><?php _e( 'Specific ID (optional):', 'our-office-by-woothemes' ); ?></label>
		...
		<p><small><?php _e( 'Display a specific office member, rather than a list.', 'our-office-by-woothemes' ); ?></small></p>
<?php
	} // End form()
	...
	protected function get_orderby_options () {
		return array(
					'none' 			=> __( 'No Order', 'our-office-by-woothemes' ),
					'ID' 			=> __( 'Entry ID', 'our-office-by-woothemes' ),
					'title' 		=> __( 'Title', 'our-office-by-woothemes' ),
					'date' 			=> __( 'Date Added', 'our-office-by-woothemes' ),
					'menu_order' 	=> __( 'Specified Order Setting', 'our-office-by-woothemes' ),
					'rand' 			=> __( 'Random Order', 'our-office-by-woothemes' )
					);
	...
	protected function get_order_options () {
		return array(
					'ASC' 			=> __( 'Ascending', 'our-office-by-woothemes' ),
					'DESC' 			=> __( 'Descending', 'our-office-by-woothemes' )
					);
