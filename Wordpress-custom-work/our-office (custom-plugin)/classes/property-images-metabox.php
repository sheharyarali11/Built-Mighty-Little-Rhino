...
function list_office_images( $ptyimg = false ){
...
function get_office_images_ids($thumbnail = false, $id = false){
	...
	$list_images = list_office_images( get_post_type( $id ) );
...
function get_office_images_src($size = 'medium',$thumbnail = false, $id = false){

	if($id)

		$images = $thumbnail ? get_office_images_ids(true,$id) : get_office_images_ids(false,$id);

	else 

		$images = $thumbnail ? get_office_images_ids(true) : get_office_images_ids();
...
function get_multi_office_images_src($small = 'thumbnail',$large = 'full',$thumbnail = false, $id = false){
