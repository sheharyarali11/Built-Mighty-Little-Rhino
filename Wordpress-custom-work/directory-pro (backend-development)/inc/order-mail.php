...
global $wpdb;			
	...
	$total_g =($iv_directories_package_cost - $dis_amount).' '.$api_currency;
	...
	if( $trial_enable!='yes' ){	
			...
			$my_post_form = array('post_title' => wp_strip_all_tags($package_name), 'post_name' => wp_strip_all_tags($package_name), 'post_content' => $total_g, 'post_status' => 'publish', 'post_author' => $userId,'post_type' => 'iv_payment');
