...
?>
<section id="slider-search" class="mb-5" style="background: transparent; margin: 0; padding:0;">
  <div class="bootstrap-wrapper" style="background: transparent;">
    <div class="container" style="background: transparent;">
      <div class="row my-0 py-0">
        <div class="col-md-12 my-0 py-0">
          <form class="p-0 m-0" method="POST"  id="dirprosearch" name="dirprosearch" role="form" <?php echo esc_html($form_action);?>>
            <div class="form-row" style="line-height: 0px !important;">
							<div class="form-group col-md-12">
								<div class="inner-addon left-addon mx-0 d-flex align-items-center">
									...
									<input type="text"  value="<?php echo esc_html($dirsearch);?>" class="" id="dirsearch" name="dirsearch" style="height: 40px !important;font-size: 14px !important;width:100%;" placeholder="<?php esc_html_e('Search','ivdirectories');?>"/>
							...
							<div class="form-group col-md-12">
								<div class="inner-addon right-addon d-flex align-items-center">
									...
									<input type="text" class="" value="<?php echo esc_html($location);?>" style="height: 40px !important;font-size: 14px !important;width:100%;" placeholder="<?php  esc_html_e('Location','ivdirectories');?>" id="location" name="location"  />
									<input type="hidden"  value="<?php echo esc_html($locationtype);?>"  id="locationtype" name="locationtype"/>
								</div>
							</div>
							<div class="form-group col-md-12" style="line-height: 0px !important;">
								<button type="submit" id="dirpro_sbtn" class="btn btn-sm btn-block text-center" style="height: 40px !important;font-size: 14px !important;padding: 0;border-radius: :none;"><?php esc_html_e('Search','ivdirectories');?></button>
							</div>
						</div>
					</form>
				</div>
