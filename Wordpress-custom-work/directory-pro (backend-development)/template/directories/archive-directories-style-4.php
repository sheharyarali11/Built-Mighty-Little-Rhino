...
<div class="bootstrap-wrapper">
	...
	<section class="archieve-page py-5">
		...
		<?php
			if($search_show==1){
				include(wp_iv_directories_template.'directories/archive-top-search-4.php');
			}
		?>
		<!-- end of search form -->
				...
				<div id="js-grid-meet-the-team" class="cbp cbp-l-grid-team" >
					<?php
						...
						<div class="cbp-item  <?php echo esc_attr($cat_slug); ?>" >
							...
							<div class="cbp-l-grid-projects-date" style="display:none"><?php echo esc_html(strtotime($the_query->post->post_date));?></div>
						</div>
						<?php
							$i++;
						}
