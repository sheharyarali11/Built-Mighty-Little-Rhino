						...
						<div class="col mt-2">
							<p class="text-justify">
								<?php								
									...
									$page_content_main = $post_id_1->post_content;									
									$page_content_main = str_replace(']]>', ']]&gt;', $page_content_main);
									echo $page_content_main;
								?>
							</p>
						</div>
					</div>
									...
									<?php
										if($wp_directory->check_reading_access('contact info',$id)){
											...
											<?php
												if(get_post_meta($id,'contact_name',true)!=""){
												?>
												<div class="col-md-4"><p><?php esc_html_e('Name','ivdirectories'); ?></p></div><div class="col-md-8"><p><?php echo get_post_meta($id,'contact_name',true);?></p>
												</div>
												<?php
												}
											?>
											...
											<?php
												...
												?>
												<div class="col-md-4"><p><?php esc_html_e('Website','ivdirectories'); ?></p></div><div class="col-md-8"><p><?php echo '<a style="text-decoration: none;" href="'. esc_url($contact_web).'" target="_blank"">'. esc_url($contact_web_s).'</a>';?></p>
												</div>
												<?php
												}
											?>
