            ...
            <div class="form-row" style="line-height: 0px !important;">
							<div class="form-group col-md-4">
								<div class="inner-addon left-addon mx-0 d-flex align-items-center">
									...
									<input type="text"  value="<?php echo esc_html($dirsearch);?>" class=" col-md-12" id="dirsearch" name="dirsearch" style="height: 40px !important;font-size: 14px !important;" placeholder="<?php esc_html_e('Search','ivdirectories');?>"/>
							...
							<div class="form-group col-md-4">
								<div class="inner-addon right-addon d-flex align-items-center">
									...
									<input type="text" class=" col-md-12" value="<?php echo esc_html($location);?>" style="height: 40px !important;font-size: 14px !important;" placeholder="<?php  esc_html_e('Location','ivdirectories');?>" id="location" name="location"  />
