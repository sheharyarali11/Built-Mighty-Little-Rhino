<?php
	...
	wp_enqueue_style('iv_directories-style-110', wp_iv_directories_URLPATH . 'admin/files/css/listing_style_5.css');
...
<?php
	...
	wp_enqueue_script('iv_directory-ar-script-27', wp_iv_directories_URLPATH . 'admin/files/js/archive-listing5.js');
