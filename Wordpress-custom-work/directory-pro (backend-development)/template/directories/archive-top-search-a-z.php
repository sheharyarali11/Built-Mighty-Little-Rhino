            ...
            <div class="form-row" style="line-height: 0px !important;">
							<div class="form-group col-md-4">
								<div class="inner-addon left-addon mx-0 d-flex align-items-center">
									...
									<input type="text"  value="<?php echo esc_html($dirsearch);?>" class="" id="dirsearch" name="dirsearch" style="height: 40px !important;font-size: 14px !important;width: 100%;box-shadow: none;" placeholder="<?php esc_html_e('Search','ivdirectories');?>"/>
							...
							<div class="form-group col-md-4">
								<div class="inner-addon right-addon d-flex align-items-center">
									...
									<input type="text" class="" value="<?php echo esc_html($location);?>" style="height: 40px !important;font-size: 14px !important;width: 100%;box-shadow: none;" placeholder="<?php  esc_html_e('Location','ivdirectories');?>" id="location" name="location"  />
							...
							<div class="form-group col-md-4" style="line-height: 0px !important;">
								<button type="submit" id="dirpro_sbtn" class="btn btn-sm btn-block text-center" style="height: 40px !important;font-size: 14px !important;box-shadow: none;"><?php esc_html_e('Search','ivdirectories');?></button>
							</div>
						</div>
					</form>
				</div>
